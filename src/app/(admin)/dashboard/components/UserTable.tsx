...
import { Loader2, MoreHorizontal, UserX, UserCheck, ShieldAlert, Edit } from 'lucide-react';
...
export function UserTable() {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      setUsers(data.map(u => ({...u, createdAt: u.createdAt ? new Date(u.createdAt) : undefined, updatedAt: u.updatedAt ? new Date(u.updatedAt) : undefined })));
    } catch (error) {
